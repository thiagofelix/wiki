---
title: Doctoralia / DocPlanner Group
type: entity
sources:
...
Doctoralia is the Brazilian brand of **DocPlanner Group**, the world's largest healthcare appointment booking platform. DocPlanner was founded in 2012 in Poland by Mariusz Gralewski, merged with Spain's Doctoralia in 2016, and launched its Brazilian operation in Curitiba in 2017. In Brazil, Doctoralia operates both a patient-facing appointment-booking marketplace and a SaaS suite (Doctoralia Pro) for individual doctors and clinics. In July 2022 it acquired Brazilian clinic-management SaaS **Feegow**, significantly expanding its B2B EHR and financial-management capabilities. DocPlanner reached unicorn status (≥US$1 billion valuation) in 2021 and has raised approximately €300 million in total. Among Brazilian platforms, Doctoralia is distinctive for combining a high-traffic patient marketplace with practitioner SaaS tools — a model not replicated by [[iclinic]], [[shosp]], [[clinica-nas-nuvens]], [[pixeon]], or [[mv-sistemas]]. See [[market-overview]] for competitive context.

## Key Facts

| Attribute | Detail |
|-----------|--------|
| **DocPlanner Founded** | 2012 (Warsaw, Poland) |
...
- **Mariusz Gralewski** — Founder and Global CEO, DocPlanner Group. The idea originated in 2010 when Gralewski struggled to find a vetted specialist doctor late at night; he purchased the ZnanyLekarz platform as the foundation. ([TechRound interview](https://techround.co.uk/interviews/meet-mariusz-gralewski-docplanner/))

## Funding & Ownership

DocPlanner Group has raised approximately **€300 million** in total across multiple rounds:

| Round | Date | Amount | Lead Investors |
|-------|------|--------|----------------|
| Seed | December 2012 | $1 million | Point Nine Capital, Piton Capital, RTA Ventures |
| Series A | September 2013 | $3 million | Point Nine, Piton, RTA |
| Series B | May 2015 | $10 million | EBRD (lead), Point Nine, Piton, RTA |
...
This funding scale is far larger than any other platform in the Brazilian clinical SaaS segment. Compare to [[iclinic]]'s €27.9M acquisition by Afya, or [[clinica-nas-nuvens]]'s R$ 28.5M acquisition by Bionexo.

## Key Features

### For Individual Health Professionals (Doctoralia Pro)
- Professional profile with Google-optimized visibility
- 24/7 online appointment booking for patients
- Automatic reminder and confirmation messages to reduce no-shows
- Electronic medical record (prontuário eletrônico) — extended via the Feegow acquisition
...
- Multi-professional agenda management
- Advanced clinic management from the integrated Feegow platform
- Insurance/convênio billing support including anti-glosa tools (from Feegow)
- Marketing and patient-flow optimization

### Patient-Side Marketplace
...
Subscription SaaS; pricing as reported on [Capterra](https://www.capterra.com/p/253301/Doctoralia-Pro/) and [GetApp](https://www.getapp.com/customer-management-software/a/doctoralia-pro/). A free professional profile tier also exists on the marketplace:

| Plan | Price |
|------|-------|
| **For Health Professionals** | €69 per user per month |
| **For Clinics** | €129 per month |
...
|------------------------|--------|
| [[tiss]] billing | ✅ — Via Feegow integration; includes anti-glosa tools |
| Telemedicine | ✅ — Fully integrated; 1 million+ appointments/month (in-person + telemedicine, 2022) |
| [[telemedicine-regulation]] | ✅ — Integrated video teleconsulta |
| [[lgpd-health-data]] | ✅ — ISO/IEC 27001 certified data security |
| SBIS certification | Not confirmed in available sources |
| WhatsApp / Social Networks | ✅ — Booking via multiple channels |
...
- Present in 13+ countries: Poland, Brazil, Mexico, Spain, Italy, Germany, Turkey, Colombia, Czech Republic, Portugal, Argentina, Peru, Chile
- ~2 million healthcare professionals listed globally
- Goal: support 1 billion patient visits annually
