...
- [[amplimed]] — Healthcare connection hub acquired by Raia Drogasil (2021); AI suite "Amélia"; 70K+ professionals
- [[feegow]] — Clinic management with SBIS NGS2 certification; acquired by DocPlanner Group (July 2022)
- [[ninsaude]] — Ninsaúde Apolo: franchise-focused, multilingual clinic system with ASD/ABA specialty
- [[tuotempo]] — Enterprise patient engagement CRM for hospitals/polyclinics; part of DocPlanner Group
- [[hidoctor]] — Brazil's only true multi-platform system (desktop+web+mobile+offline); 35+ years by Centralx
...
- [[tiss]] — TISS/TUSS: Brazil's mandatory health insurance interchange standard and unified terminology
- [[lgpd-health-data]] — LGPD applied to health data: legal bases, compliance requirements, and penalties
- [[telemedicine-regulation]] — Evolution of telemedicine regulation in Brazil (2002–2026): CFM resolutions and federal law
...
- [[market-overview]] — Brazilian healthtech market: USD 10.66B (2024) → USD 44.6B (2034); infrastructure and growth drivers
- [[mna-landscape]] — M&A activity, key investors/VCs, and consolidation trends in Brazilian healthtech
